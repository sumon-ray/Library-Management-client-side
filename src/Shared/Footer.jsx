	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				{/* <img src="" alt="" /> */}
					<img className='w-24 rounded-full' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPfXLK1KjACQYScfqsGQRPhpXhgE0SdvNdSp1jFqxNu4ntvAe-rKZoShi4L_hpxqV6fn4&usqp=CAU' alt="" />
				</div>
				<span className="self-center text-2xl font-semibold">Library </span>
			</a>
		</div>
