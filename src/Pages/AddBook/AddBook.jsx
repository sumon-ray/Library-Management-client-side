...
//   
  ...
  <div  >
     ...
     <section  className={ `${theme==="light" ? "bg-slate-900 bg-opacity-60 text-slate-600" : "dracula"} my-8 max-w-4xl shadow-md shadow-slate-500 p-6 mx-auto rounded-md border-2 border-slate-600`}>
    ...
    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
        ...
        <div>
            ...
            <input placeholder="type book name " name="name" id="emailAddress" type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
        </div>
    ...
    <div className="flex justify-end mt-6">
        <button className="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600 btn ">Add Book</button>
    </div>
</form>
