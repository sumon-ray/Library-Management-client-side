...
const Login = () => {
  ...
  return (
    <div>
      <header className="bg-gray-900 attern">
                  ...
                  <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8  ">
                    ...
                    <div className="my-6 space-y-4">
                      <button
                        ...
                        type="button"
                        className="dark:text-gray-100 flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600"
                      >
                        <svg
                        ...
                        <p className="dark:text-gray-100">Login with Google</p>
                      </button>
                    </div>
                    ...
                    <form noValidate="" action="" className="space-y-8">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <a
                              rel="noopener noreferrer"
                              href="#"
                              className=" text-xs hover:underline dark:text-gray-100"
                            >
                              Forgot password?
                            </a>
                          </div>
                      ...
                      <button
                        ...
                        type="button"
                        className=" dark:bg-blue-500 w-full px-8 py-3 font-semibold rounded-md  dark:text-gray-50"
                      >
                        Sign in
                      </button>
                    </form>
