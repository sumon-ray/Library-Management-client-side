                    ...
                    <div className="flex flex-col  items-center py-6  lg:flex-row">
                        <div className="lg:w-1/2">
                            ...
                            <p className="mt-4 text-gray-100">
                                ...
                                adipisci quod porro et non exercitationem quasi, maxime culpa ut nemo ab delectus saepe
                                iste nostrum explicabo a?
                            </p>
                        </div>
                        ...
                        <div className="flex my-8 lg:w-1/2 lg:justify-end lg:mt-0">
                            <div className="w-full max-w-md bg-white rounded-lg dark:bg-gray-800">
                                <div className="px-6 py-3 text-center">
                                    <h2 className="text-2xl font-semibold text-gray-700 dark:text-white mb-4">Sign In</h2>
